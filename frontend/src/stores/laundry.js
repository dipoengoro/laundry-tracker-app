...
export const useLaundryStore = defineStore('laundry', {
    ...
    actions: {
        async fetchSessions() {
            ...
            try {
                const response = await api.get('/laundry-sessions/')
        ...
        async createSession(sessionData) {
            ...
            try {
                const response = await api.post('/laundry-sessions/', sessionData)
        ...
        async updateSessionStatus(sessionId, status) {
            ...
            try {
                const response =
                    await api.put(`/laundry-sessions/${sessionId}/status`, {status})
